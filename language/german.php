...
$lang = array(
	...
	//Teamspeak 3
	'ts3'							=> 'Teamspeak 3',
	'voice_f_ts3_ip'				=> 'Die Server IP or Hostname (ohne Port)',
	'voice_f_help_ts3_ip'			=> 'Z.B. 127.0.0.1 oder yourdomain.com',
	'voice_f_ts3_port'				=> 'Der Port',
	'voice_f_help_ts3_port'			=> 'Standard: 9987',
	'voice_f_ts3_telnetport'		=> 'Der Telnet Port deines Servers',
	'voice_f_help_ts3_telnetport'	=> 'Standard: 10011',
	'voice_f_ts3_id'				=> 'Die ID deines Server',
	'voice_f_help_ts3_id'			=> 'Standard: 1. Gib -1 ein um anstatt der ID den Port deines Server zum Verbinden zu nutzen.',
	...
	'voice_f_ts3_stats_showos'		=> 'Zeige das Betriebssystem des Servers in der Statistikbox?',
	...
	'voice_f_ts3_sshport'			=> 'SSH-Port',
	'voice_f_help_ts3_sshport'		=> 'Standard: 10022',
    ...
    'voice_f_help_ts3_query_url'    => 'Trage die vollständige URL zum WebQuery ein, inklusive Protokoll und Port, z.B. https://domain.com:10443',
    'voice_f_ts3_query_api_key'     => 'WebQuery API-Key',
    'voice_f_help_ts3_query_api_key' => 'Trage den erzeugten API-Key hier ein (Scope=manage)',
