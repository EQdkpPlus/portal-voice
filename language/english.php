...
$lang = array( 
	...
	"ts3" => 'Teamspeak 3',
	"voice_f_ts3_ip" => 'Your Server IP or Hostname (without Port)',
	'voice_f_help_ts3_ip'			=> 'E.g. 127.0.0.1 or yourdomain.com',
	"voice_f_ts3_port" => 'The port',
	'voice_f_help_ts3_port'			=> 'Default: 9987',
	'voice_f_help_ts3_telnetport'	=> 'Default: 10011',
	"voice_f_ts3_telnetport" => 'The Telnet Port of your Server',
	"voice_f_ts3_id" => 'The ID from your Virtual Server',
	"voice_f_help_ts3_id" => 'Default: 1. Enter -1 to use the servers port to connect instead of the servers id.',
	...
	2 => 'Min',
		...
		'voice_f_help_ts3_sshport'		=> 'Default: 10022',
		'voice_f_ts3_sshuser'			=> 'SSH-User',
		'voice_f_help_ts3_sshuser'		=> 'Insert here the SSH credentials for the TS3 serverquery.',
